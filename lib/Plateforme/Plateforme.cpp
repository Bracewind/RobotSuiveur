...
Plateforme::Plateforme(int pinGaucheMGauche, int pinDroiteMGauche,
                       int pinPWMMGauche, int pinGaucheMDroite,
                       int pinDroiteMDroite, int pinPWMMDroite)
    : m_moteurGauche(Moteur(pinDroiteMGauche, pinGaucheMGauche, pinPWMMGauche)),
      m_moteurDroit(Moteur(pinGaucheMDroite, pinDroiteMDroite, pinPWMMDroite)) {

}

void Plateforme::connecteMoteurGauche(int pinGauche, int pinDroite,
                                      int pinPWM) {
